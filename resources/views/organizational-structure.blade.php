...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Laravel') }} - Organizational Structure">
    <title>Organizational Structure - {{ config('app.name', '') }}</title>
...
<body class="retro-modern">
    ...
    <main style="padding-top: 80px;">
        ...
        <section id="organizational-structure" class="py-5" style="background: #f8fbfd;">
            <div class="container">
                <div class="section-header">
                    <span class="section-badge retro-label">Organizational Structure</span>
                    <h1 class="retro-section-title">Organizational Structure</h1>
                </div>
                <div class="bg-white rounded-4 p-4 shadow-sm border">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="bg-success bg-opacity-10 rounded-3 p-3 text-center">
                                <h3 class="h6 fw-bold mb-0" style="color: #009639;">Board of Regents</h3>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="text-center">
                                <div style="width: 2px; height: 20px; background: #009639; margin: 0 auto;"></div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="bg-success bg-opacity-10 rounded-3 p-3 text-center">
                                <h3 class="h6 fw-bold mb-0" style="color: #009639;">University President</h3>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="text-center">
                        ...
                        <div class="col-md-3">
                            <div class="bg-light rounded-3 p-3 text-center h-100">
                                <p class="small fw-bold mb-0">Academic Affairs</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="bg-light rounded-3 p-3 text-center h-100">
                                <p class="small fw-bold mb-0">Research & Extension</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="bg-light rounded-3 p-3 text-center h-100">
                                <p class="small fw-bold mb-0">Administration</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="bg-light rounded-3 p-3 text-center h-100">
                                <p class="small fw-bold mb-0">Planning & Development</p>
                            </div>
                        </div>
                    </div>
                </div>
