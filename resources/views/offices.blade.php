...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Laravel') }} - Offices">
    <title>Offices - {{ config('app.name', '') }}</title>
...
<body class="retro-modern">
    ...
    <main style="padding-top: 80px;">
        <!-- Offices -->
        <section id="offices" class="py-5" style="background: #f8fbfd;">
            <div class="container">
                <div class="section-header">
                    <span class="section-badge retro-label">Offices</span>
                    <h1 class="retro-section-title">Offices</h1>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-2">Office of the President</h3>
                            <p class="text-muted small mb-0">Executive leadership and university governance.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-2">Academic Affairs</h3>
                            <p class="text-muted small mb-0">Instruction, curriculum, and academic programs.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-2">Student Affairs</h3>
                            <p class="text-muted small mb-0">Student services, welfare, and development.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-2">Administrative Services</h3>
                            <p class="text-muted small mb-0">Finance, HR, and facilities management.</p>
                        </div>
                    </div>
                </div>
            </div>
