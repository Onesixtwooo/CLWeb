    ...
    <main>
        ...
        <section class="explore-header">
            <div class="container text-center">
                <h1 class="explore-header-title">{{ $sectionTitle }}</h1>
                @if (!empty($sectionDescription))
                    <div class="explore-header-description">
                        {!! nl2br(e($sectionDescription)) !!}
                    </div>
                @endif
            </div>
        </section>
            ...
            <div class="container pb-5">
                @if (empty($exploreItems) || count($exploreItems) === 0)
                    <div class="empty-state">
                        ...
                        <h3>No items to explore yet</h3>
                        <p>Check back soon for laboratories and facilities information.</p>
                    </div>
                @else
                    <div class="row g-4">
                        @foreach ($exploreItems as $item)
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="explore-card">
                                    @if (!empty($item['image']))
                                        <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="explore-card-image">
                                    @else
                                        <div class="explore-card-image d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, {{ $headerColor }}20 0%, {{ $accentColor }}20 100%);">
                                            <svg width="64" height="64" fill="{{ $headerColor }}" opacity="0.3" viewBox="0 0 16 16">
                                    ...
                                    <div class="explore-card-body">
                                        <h3 class="explore-card-title">{{ $item['name'] }}</h3>
                                        @if (!empty($item['description']))
                                            <p class="explore-card-description">{{ Str::limit(strip_tags($item['description']), 150) }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
