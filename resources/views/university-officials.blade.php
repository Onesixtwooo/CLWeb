...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Laravel') }} - University Officials">
    <title>University Officials - {{ config('app.name', '') }}</title>
...
<body class="retro-modern">
    ...
    <main style="padding-top: 80px;">
        ...
        <section id="university-officials" class="py-5">
            <div class="container">
                <div class="section-header">
                    <span class="section-badge retro-label">University Officials</span>
                    <h1 class="retro-section-title">University Officials</h1>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-1">Office of the President</h3>
                            <p class="text-muted small mb-0">University President</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-1">Office of the VPAA</h3>
                            <p class="text-muted small mb-0">Vice President for Academic Affairs</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-white rounded-4 p-4 h-100 shadow-sm border text-center">
                            <h3 class="h6 fw-bold mb-1">Office of the VP for Admin</h3>
                            <p class="text-muted small mb-0">Vice President for Administration</p>
                        </div>
                    </div>
                </div>
            </div>
