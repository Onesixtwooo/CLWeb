...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Laravel') }} - Campus Life">
    <title>Campus Life - {{ config('app.name', '') }}</title>
...
<body class="retro-modern">
    ...
    <main style="padding-top: 80px;">
        <!-- Campus Life -->
        <section id="campus-life" class="py-5">
            <div class="container">
                <div class="section-header">
                    <span class="section-badge retro-label">Campus Life</span>
                    <h1 class="retro-section-title">Campus Life</h1>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-white rounded-4 overflow-hidden shadow-sm border h-100">
                            <div class="ratio ratio-16x9">
                                <img src="{{ asset('images/wc1.jpg') }}" alt="Campus life" class="w-100 h-100 object-fit-cover">
                            </div>
                            <div class="p-4">
                                <h3 class="h6 fw-bold mb-2">Student Activities</h3>
                                <p class="text-muted mb-0">Organizations, events, and campus traditions build community and pride.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-white rounded-4 overflow-hidden shadow-sm border h-100">
                            <div class="ratio ratio-16x9">
                                <img src="{{ asset('images/Library-clean.webp') }}" alt="Learning spaces" class="w-100 h-100 object-fit-cover">
                            </div>
                            <div class="p-4">
                                <h3 class="h6 fw-bold mb-2">Learning Spaces</h3>
                                <p class="text-muted mb-0">Libraries, labs, and study areas support academic excellence.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-white rounded-4 overflow-hidden shadow-sm border h-100">
                            <div class="ratio ratio-16x9">
                                <img src="{{ asset('images/infirmary.jpg') }}" alt="Student services" class="w-100 h-100 object-fit-cover">
                            </div>
                            <div class="p-4">
                                <h3 class="h6 fw-bold mb-2">Student Services</h3>
                                <p class="text-muted mb-0">Support services promote wellness, inclusion, and success.</p>
                            </div>
                        </div>
                    </div>
                </div>
