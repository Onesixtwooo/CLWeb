...
return new class extends Migration
{
    ...
    {
        Schema::create('college_trainings', function (Blueprint $table) {
            $table->id();
        ...
        $sections = \App\Models\CollegeSection::where('section_slug', 'training')->get();
        foreach ($sections as $section) {
            ...
            foreach ($items as $index => $item) {
                \App\Models\CollegeTraining::create([
    ...
    {
        Schema::dropIfExists('college_trainings');
    }
};
