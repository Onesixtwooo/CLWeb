                ...
                <a href="<?php echo e(route('college.show', $collegeSlug ?? 'engineering')); ?>" class="navbar-brand d-flex align-items-center gap-2 logo">
                    ...
                    <div class="logo-text d-flex flex-column">
                        <h2 class="retro-heading mb-0">
                            <span class="logo-full-text d-none d-md-inline"><?php echo e(strtoupper($collegeName)); ?></span>
                            <span class="logo-short-text d-inline d-md-none"><?php echo e($collegeShortName); ?></span>
                        </h2>
                        <p class="retro-subtitle">
                            <span class="d-inline d-md-none">CLSU</span>
                            <span class="d-none d-md-inline"><?php echo e($collegeName); ?>, Central Luzon State University</span>
                        </p>
                    </div>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-md-0 align-items-md-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="aboutDropdown">
                                ...
                                <li><a href="<?php echo e(route('college.show', $collegeSlug ?? 'engineering')); ?>#organizations" class="dropdown-item">Student Organizations</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
